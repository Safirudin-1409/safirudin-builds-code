...
const Home = () => {
  ...
  return (
    <div className="section-hero min-h-screen flex items-center justify-center relative overflow-hidden">
      {/* Floating Elements */}
      <div className="absolute top-20 left-10 w-20 h-20 bg-white/10 rounded-full float-animation" />
      <div className="absolute top-40 right-20 w-32 h-32 bg-white/5 rounded-full float-animation" style={{ animationDelay: '2s' }} />
      <div className="absolute bottom-20 left-20 w-16 h-16 bg-white/10 rounded-full float-animation" style={{ animationDelay: '4s' }} />
      ...
      <div className="container mx-auto px-6 text-center text-white relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-4 font-light fade-in stagger-2">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-3/4 left-1/3 w-1 h-1 bg-white rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 right-1/4 w-1 h-1 bg-white rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
        <div className="absolute bottom-1/4 right-1/3 w-2 h-2 bg-white rounded-full animate-pulse" style={{ animationDelay: '3s' }} />
      </div>
    </div>
  );
};
